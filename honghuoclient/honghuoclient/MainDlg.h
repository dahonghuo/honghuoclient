...
public:
	...
	CStaticTrans     m_strSrcAddr5;       //最近交易5源地址
	CStaticTrans     m_strSrcAddr6;       //最近交易6源地址
	...
	CStaticTrans     m_strAmount5;        //最近交易5转账金额
	CStaticTrans     m_strAmount6;        //最近交易6转账金额
	...
	CStaticTrans     m_strDesAddr5;       //最近交易5目的地址    
	CStaticTrans     m_strDesAddr6;       //最近交易6目的地址  

	CMFCLinkCtrl    *m_vlinkCtrl1;         //社区动态超链接1
	CMFCLinkCtrl    *m_vlinkCtrl2;         //社区动态超链接2
	CMFCLinkCtrl    *m_vlinkCtrl3;         //社区动态超链接3
	CMFCLinkCtrl    *m_vlinkCtrl4;		   //社区动态超链接4
	CMFCLinkCtrl    *m_vlinkCtrlQQ;        //官方客服QQ超链接
	CMFCLinkCtrl    *m_vlinkCtrlBlock;     //官方区块浏览器
