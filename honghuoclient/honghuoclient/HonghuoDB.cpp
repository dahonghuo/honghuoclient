...
void ChuobiApp::UpdateAppRecord(string txdetail){
...
//弹出交易冒泡提示
void ChuobiApp::PopupContactBalloonTip(uistruct::REVTRANSACTION_t tx)
{
...
void ChuobiApp::PopupCommBalloonTip(string hash)
{
	string conditon;
...
void ChuobiApp::InsertTransaction(string hash)
{
...
void  ChuobiApp::InsertAddrBook(uistruct::ADDRBOOK_t addr)
{
	string strSourceData;
...
void  ChuobiApp::UpdateAddrBook(uistruct::ADDRBOOK_t addr)
{
...
void ChuobiApp::SyncTransaction(string obj)
{
	uistruct::REVTRANSACTION_t transcion;
...
void ChuobiApp::DeleteItemTransaction(int height)
{
...
void ChuobiApp::UpdateAddressData(){
	string strCommand;
...
void ChuobiApp::UpdateTransaction(string hash){
